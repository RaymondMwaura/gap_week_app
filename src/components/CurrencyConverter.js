...
import LoadSpinner from "./Loader/MainLoader";
import Labels from "./CurrencyConverterLayout/Labels/Labels";
import CountrySelection from "./CurrencyConverterLayout/CountrySelection/CountrySelection";
import CurrencyDetails from "./CurrencyConverterLayout/CurrencyDetails/CurrencyDetails";
import ExchangeValue from "./CurrencyConverterLayout/ExchangeValue/ExchangeValue";
import loadSupportedCountries from "../store/actions/countryActions";
import { loadingComplete } from "../store/actions/fetchingActions";
import {
  updateExchangeRate,
  changeAmount,
  changeCurrency1,
...
class CurrencyConverter extends Component {
  async componentDidMount() {
    ...
    const SUPPORTED_CURRENCIES_URL =
